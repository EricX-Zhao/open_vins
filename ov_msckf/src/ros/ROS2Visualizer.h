...
protected:
  ...
  // Service to request a full system reset at runtime (handy for testing re-initialization)
  ...
  rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr fcs_odom_sub_;
